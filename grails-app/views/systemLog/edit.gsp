...
<html>
	...
	<body>
		...
		<div id="edit-systemLog" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${systemLogInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${systemLogInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:systemLogInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${systemLogInstance?.version}" />
				<fieldset class="form">
