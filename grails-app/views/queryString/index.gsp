...
<html>
	...
	<body>
		<a href="#list-queryString" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-queryString" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="comment" title="${message(code: 'queryString.comment.label', default: 'Comment')}" />
					
						<g:sortableColumn property="sqlString" title="${message(code: 'queryString.sqlString.label', default: 'Sql String')}" />
				...
				<g:each in="${queryStringInstanceList}" status="i" var="queryStringInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${queryStringInstance.id}">${fieldValue(bean: queryStringInstance, field: "clazz")}</g:link></td>
